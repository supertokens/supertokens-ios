...
MYSQL_USER=tempuser JAVA=/Users/travis/build/supertokens/jdk-12.0.2.jdk/Contents/Home/bin/java TEST_MODE=testing INSTALL_PATH=../../../com-root node ./build/index.js &
cd ../../
